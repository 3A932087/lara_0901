...
<div class="container-fluid px-4">
    ...
    <form action="{{route('admin.posts.store')}}" method="post"><!--用post方法將表單內的資料傳送到路由admin.posts.store-->
        ...
        <div class="mb-3">
            ...
            <input name="title" id="title" type="text" class="form-control" placeholder="請輸入文章標題" value="{{old('title')}}"><!--單行輸入框-->
        </div>
        <div class="mb-3">
            <label for="content" class="form-label">文章內容</label>
            <textarea name="content" id="content" class="form-control" rows="10" placeholder="請輸入文章內容">{{old('content')}}</textarea><!--多行輸入框-->
        </div>
        <div class="mb-3">
        ...
        <div class="d-grid gap-md-flex justify-content-md-end">
